...
class Office(models.Model):
    ...
    postal_code = models.CharField(verbose_name="郵便番号", max_length=16, null=True, blank=True)
    address = models.CharField(verbose_name="事業所所在地", max_length=64, null=True, blank=True)
    phone = models.CharField(verbose_name="電話番号", max_length=16, null=True, blank=True)
    fax = models.CharField(verbose_name="FAX番号", max_length=16, null=True, blank=True)
    town_code = models.CharField(verbose_name="事業所所在地の市区町村番号", max_length=16, null=True, blank=True)
    ...
    foundation_date = models.DateField(verbose_name="設立年月日", null=True, blank=True)
    number_of_employees = models.IntegerField(verbose_name="従業員人数", null=True, blank=True)
    def __str__(self):
        return self.name
